...
function formatTime(iso) {
  // "2026-04-25T14:30:05.123456" → "14:30:05.123"
    ...
    <div className="app">
      <header className="header">
        <div className="header-left">
          <h1>Gesture Control Log</h1>
          <span className={`live-dot ${isLive ? 'live' : 'offline'}`} title={isLive ? 'Receiving events' : 'Cannot read log file'} />
